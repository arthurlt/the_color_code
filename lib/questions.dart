  ...
  for (int i = 0; i < questionList.length; i++) {
    if (questionList[i]['definitions']) {
      ...
      for (final color in Question.colors) {
        questionCard.answers[color] =
            questionList[i]['choices'][color]['answer'];
        questionCard.definitions[color] =
            questionList[i]['choices'][color]['definition'];
      }
...
class Question {
  ...
  Map answers =
      Map<String, String?>.fromIterable(colors, key: (i) => i, value: null);
  String? selected;
